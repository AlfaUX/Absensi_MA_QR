...
class AbsensiModel extends Model
{
    ...
    protected $allowedFields = ['id_siswa', 'tanggal', 'waktu', 'waktu_absensi', 'id_keterangan'];
    ...
    // Insert absensi dengan waktu yang benar
    public function insertAbsensi($data)
    {
        return $this->db->table('tb_absensi')->insert([
            ...
            'tanggal'       => date('Y-m-d'),
            'waktu'         => date('H:i:s') // Perbaikan penulisan waktu
        ]);
    }
    ...
    {
        return $this->db->table('tb_absensi')
            ->select('tb_absensi.id_siswa, tb_siswa.nisn, tb_siswa.nama_siswa, tb_keterangan.keterangan, tb_absensi.tanggal, tb_absensi.waktu_absensi')
